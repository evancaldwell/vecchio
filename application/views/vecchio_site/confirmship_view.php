...
<div class="float_fix">
	<div class="container">
		...
		<h3>Click And Drag Green Marker If Necessary</h3>
           <div id="contact">
           		<div id="map_canvas"  style="width:704px; height:600px; float:left; border: 3px solid #986C47;"></div>
		   		<div id="control_panel" style="width:240px; float:right;text-align:left;padding-top:20px">
