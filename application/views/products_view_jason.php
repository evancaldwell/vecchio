...
<div id="headerimgs_ns"> 
	...
	<div id="product_window">
        ...
        <?php if (is_array($products)){?>
			<div id="product_logo" ><div id="bubble"><h2><?php echo $products[0]['description']; ?>
					<span style="font-size:10px;"><button id="click_other">View Other Products</button></span></h2>
		   ...
		   <?php } 
           	...
           	<div id="product_logo" ><div id="bubble"><h2>Nothing Available in This Category</h2></div></div>
           <?php } ?>
		<div id="other_products" title="Choose Another Product">
			<table border="0" cellpadding="0" cellspacing="0">
			<tr><td colspan="2">
				<p>Select from our product lines: </p>
			</td></tr>
				<tr><td>
			<select name="avail_prod" id="avail_prod">
			<?php
			$first = 0;
		 	foreach($avail as $a) {
			    $extra = " &raquo; " .$a['cnt'] ." available";
				echo "<option value='" . $a['product_type_id'] . "' ".($first == 0 ? 'selected="selected"' : '' )." >";
				echo $a['description'] . " - " . $a['specs'] . " </option> \r\n";
				$first ++;
			}?>
			</select>
			</td>
			<td><button id="go_product">Go</button></td>
			</tr>
			</table>
		</div>
	</div>
