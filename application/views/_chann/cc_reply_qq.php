	...
	<div id="my_account">
					...
					<div id="tagged_items">
						...
						<div style="margin:5px 0px 0px 55px; background-color:white; padding:10px; border: 1px solid #CCC">
							...
							<?php 
							$dt = array('id' => 'dwn_lnk');
							echo anchor('vecchio_download/receipt_qq/' . $qq_id , "Download Transaction Confirmation Report &#9660;", $dt);?></p>
						...
						<div style="margin:5px 0px 25px 55px; background-color:white; padding:10px; border: 1px solid #CCC">
							...
							<h2 style="font-size:14px;  ">Step 2: Choose a date to ship your products</h2>
							...
							<br /><br />
							<div>
							<button id="schedule">Schedule Order Ship Date</button>
							</div>
						</div>
						<?php echo form_close();
						} else {
