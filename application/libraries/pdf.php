...
class pdf extends TCPDF {
	...
	private $_footer_text; //This will hold your custom text
	...
	//Page header
	    public function Header() {
					$this->Button('print', 20, 8, 'Print', 'Print()', array('lineWidth'=>2, 'borderStyle'=>'beveled', 'fillColor'=>array(128, 196, 255), 'strokeColor'=>array(64, 64, 64)),array(),10,8);
	        // Logo
	
	        $image_file = K_PATH_IMAGES.'vc_email_top_s1.jpg';
	        $this->Image($image_file, 10, 10, 196, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);	
	    ...
	    public function Footer() {
	        ...
	        // Page number
			$footer_text = "VECCHIO TREES - 4285 Spyres Way Modesto, CA 95356	T: 855/819-7777 F: 855/828-6708                  " . 'Page '.$this->getAliasNumPage().'/'.$this->getAliasNbPages();
