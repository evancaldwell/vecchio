...
|
*/
$config['base_url']	= 'http://www.holeshotoil.com/vecchiotrees/';
...
|
*/
$config['encryption_key'] = '5uck1ttrCptDwnmYM3tbl5038956foo1';
...
|--------------------------------------------------------------------------
|
| This section is to set the variables needed to communicate with the 
| Authorize.net server
|
*/
/*
$config['at_login']	= "7SU98mzq"; //your login
$config['at_password']	= "364q5LsYeT3N5u6r"; //your transaction key
...
$config['at_login']	= "6fWyzDK4U2Ly"; //your login
$config['at_password']	= "85D7ugk9F3893V37"; //your transaction key
